...
void draw_image_portion(int destination_row, int destination_col, int source_row, int source_col, int source_width,
    int source_height, const u16* image, int image_width)
{
    // Your code goes here
    int i;
    for (i = 0; i < source_height; i++) {
        DMA[3].src = image + source_row * image_width + source_col + i * image_width;
        DMA[3].dst = &videoBuffer[destination_col + destination_row * image_width + i * 240];
